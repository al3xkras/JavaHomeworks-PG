...
package com.al3xkras.java_homeworks_pg.lab11;
...
public final class Util {
	...
	public static List<String[]> loadCSV(String filename) {
		String classpath=Paths.get("").toAbsolutePath()+"/";
		try (InputStream inputStream = new FileInputStream(classpath+filename)) {
